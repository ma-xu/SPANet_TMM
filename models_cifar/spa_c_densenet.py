...
class SPACLayer(nn.Module):
    def __init__(self, inchannel, channel, reduction=3):
        ...
        if inchannel !=channel:
            self.matcher = nn.Sequential(
                ...
                nn.BatchNorm2d(inchannel//reduction),
                nn.ReLU(inplace=True),
                nn.Conv2d(inchannel//reduction, channel, 1,bias=False),
...
class Bottleneck(nn.Module):
    def __init__(self, in_planes, growth_rate):
        ...
        self.spa = SPACLayer(in_planes,growth_rate)
