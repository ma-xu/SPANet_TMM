...
class Block(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, expansion, stride):
        ...
        self.SPAC = SPACLayer(in_planes,out_planes)
...
class SPACMobileNetV2(nn.Module):
    ...
    def __init__(self, num_classes=10):
        super(SPACMobileNetV2, self).__init__()
...
def demo():
    net = SPACMobileNetV2(num_classes=100)
