...
__all__ = ['SECResNet18','SECResNet50','SECResNet101']
...
def SECResNet18(num_classes=10):
    return SECResNet(SEPreActBlock, [2,2,2,2],num_classes)


def SECResNet34(num_classes=10):
    return SECResNet(SEPreActBlock, [3,4,6,3],num_classes)


def SECResNet50(num_classes=10):
    return SECResNet(SEPreActBootleneck, [3,4,6,3],num_classes)


def SECResNet101(num_classes=10):
    return SECResNet(SEPreActBootleneck, [3,4,23,3],num_classes)


def SECResNet152(num_classes=10):
    return SECResNet(SEPreActBootleneck, [3,8,36,3],num_classes)
