...
__all__ = ['spa_124_resnet18', 'spa_124_resnet34', 'spa_124_resnet50', 'spa_124_resnet101', 'spa_124_resnet152']
...
def spa_124_resnet18(pretrained=False, **kwargs):
...
def spa_124_resnet34(pretrained=False, **kwargs):
...
def spa_124_resnet50(pretrained=False, **kwargs):
...
def spa_124_resnet101(pretrained=False, **kwargs):
...
def spa_124_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = spa_124_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(100):
        net = spa_124_resnet50(num_classes=1000).cuda()
