...
__all__ = ['spa_resnet18', 'spa_resnet34', 'spa_resnet50', 'spa_resnet101', 'spa_resnet152']
...
def spa_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = spa_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(100):
        net = spa_resnet50(num_classes=1000).cuda()
