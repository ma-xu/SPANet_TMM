...
__all__ = ['spa_1247_resnet18', 'spa_1247_resnet34', 'spa_1247_resnet50', 'spa_1247_resnet101', 'spa_1247_resnet152']
...
def spa_1247_resnet18(pretrained=False, **kwargs):
...
def spa_1247_resnet34(pretrained=False, **kwargs):
...
def spa_1247_resnet50(pretrained=False, **kwargs):
...
def spa_1247_resnet101(pretrained=False, **kwargs):
...
def spa_1247_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = spa_1247_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(100):
        net = spa_1247_resnet50(num_classes=1000).cuda()
