...
__all__ = ['spa2_resnet18', 'spa2_resnet34', 'spa2_resnet50', 'spa2_resnet101', 'spa2_resnet152']
...
def spa2_resnet18(pretrained=False, **kwargs):
...
def spa2_resnet34(pretrained=False, **kwargs):
...
def spa2_resnet50(pretrained=False, **kwargs):
...
def spa2_resnet101(pretrained=False, **kwargs):
...
def spa2_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = spa2_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(100):
        net = spa2_resnet50(num_classes=1000).cuda()
