...
__all__ = ['spa_12_resnet18', 'spa_12_resnet34', 'spa_12_resnet50', 'spa_12_resnet101', 'spa_12_resnet152']
...
def spa_12_resnet18(pretrained=False, **kwargs):
...
def spa_12_resnet34(pretrained=False, **kwargs):
...
def spa_12_resnet50(pretrained=False, **kwargs):
...
def spa_12_resnet101(pretrained=False, **kwargs):
...
def spa_12_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = spa_12_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(100):
        net = spa_12_resnet50(num_classes=1000).cuda()
